<div class="container-fluid mt-1 bg-light">
    ...
    <div class="row">
        <div class="col-md-8 p-3 text-black bg-light">
            <div class="header">
                <p class="align-content-center onas text-black">Fortinet (NASDAQ: FTNT) secures the largest enterprise, service provider, and government organizations around the world.
                    Fortinet empowers its customers with intelligent, seamless protection across the expanding attack surface and the power to take on ever-increasing performance requirements of the borderless network—today and into the future.</p>
            </div>
        </div>
        <div class="row">
